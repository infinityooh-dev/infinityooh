...
const FaqSection = ({ faqToShow = "General Questions" }: FaqSectionProps) => {
    ...
    const handleFaqs = useCallback(() => {
     ...
     return ( 
         <section className="max-w-11/12 2xl:max-w-[1376px] w-full relative mx-auto pt-20 pb-32"> 
              <div className="section-sub-header">
                    <h3 className="text-4xl lg:text-left mb-8">Frequently Asked Questions</h3>
              </div>
              <div className="sticky-container relative w-full flex flex-col lg:flex-row justify-center items-start gap-16">
                    <div className="faqs w-full flex flex-col gap-8 justify-center items-center">
                        { 
                            handleFaqs().map((faq, index) => <FaqContainer key={index} faqHeader={faq.header} faqs={faq.faqs} /> ) 
                        }
                    </div>
                    <div className="sticky-cta sticky top-4 z-20 w-full lg:w-5/12 flex justify-center">
                        <div className="bg-tertiary-100 border border-black p-8 rounded-xl flex flex-col justify-center items-center gap-8 lg:max-w-[400px] w-full min-h-[210px]">
                            ...
                            <p className="flex justify-center items-center gap-2.5 text-lg">
                                <Link href="/about" className="text-xl underline font-semibold">
              ...
              </div>
            {
                ...
                <div className="browse-all flex justify-center items-center mt-8 p-2.5">
                        <Link href="/faqs" className="text-xl font-semibold underline flex items-center justify-center gap-2 underline-offset-4">
                            Browse all our FAQs
                            <span className="text-2xl"><FiArrowUpRight /></span>
                        </Link>
                </div>
